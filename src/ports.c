...
static void (*do_callback_write) (uint16_t portnum, uint8_t value) = NULL;
static uint8_t (*do_callback_read) (uint16_t portnum) = NULL;
static void (*do_callback_write16) (uint16_t portnum, uint16_t value) = NULL;
static uint16_t (*do_callback_read16) (uint16_t portnum) = NULL;
