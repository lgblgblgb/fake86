...
#error "ATA support is not working yet."

#include "ata.h"

static uint8_t idATA[512];
...
static uint8_t statusreg = 0, errorreg = 0, drivesel = 0, databuf[512];
static uint16_t dataptr = 512;
